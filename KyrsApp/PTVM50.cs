...
namespace KyrsApp
{
    public partial class PTVM50 : Form
    {
        public PTVM50()
        {
            InitializeComponent();
        ...
        private void calcAll_Click(object sender, EventArgs e)
        {
                ...
                valueItem5.Text != "" && valueItem6.Text != "")
            {
                ...
                double mNO2 = calcMNO2(param2);
                double mNO = calcMNO(mNO2);
                double mCO = calcMCO(param2);
                double mSO2 = calcMSO2(param2);
                double mC = calcMC(param2, param6);
                double mMZ = calcMZ(param2);
                double mBenzP = calcBenzP(param2);

                double mRtut = calcDyOxyPhbGxbMt(param2, 0.0014, 1, 100000);

                double dyOxy = calcDyOxyPhbGxbMt(param2, param6 * 4.187 / 1000, 0.001, 100000);

                double MtB = calcDyOxyPhbGxbMt(param2, param6 * 4.187 / 1000, 0.0008, 1000000000) * 0.2;
                double MtK = calcDyOxyPhbGxbMt(param2, param6 * 4.187 / 1000, 0.0008, 1000000000) * 0.1;
                double MtBenz = calcDyOxyPhbGxbMt(param2, param6 * 4.187 / 1000, 0.0008, 1000000000) * 0.1;
                double MtPiren = calcDyOxyPhbGxbMt(param2, param6 * 4.187 / 1000, 0.0008, 1000000000) * 0.2;
