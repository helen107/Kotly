...
namespace KyrsApp
{
    public partial class GM5014gas : Form
    {
        public GM5014gas()
        {
            InitializeComponent();
        ...
        private void kotelName_SelectedIndexChanged(object sender, EventArgs e)
        {
                
        }

        private void Kotelnaya2_Click(object sender, EventArgs e)
        {
        ...
        private void calc_Click(object sender, EventArgs e)
        {
            if (valueItem1.Text != "" && valueItem2.Text != "" && valueItem3.Text != "" && valueItem4.Text != "" &&
                ...
                valueItem9.Text != "" && valueItem10.Text != "")
            {
                calc.BackColor = Color.DarkSeaGreen;
                addToDb.BackColor = Color.DarkSeaGreen;
                ...
                double dyOxy = calcDyOxyPhbGxbMt(0.0005, param5, param10 * 4.187 / 1000, 100000);

                double MtB = calcDyOxyPhbGxbMt(0.0008, param5, param10 * 4.187 / 1000, 1000000000);
                double MtK = calcDyOxyPhbGxbMt(0.0008, param5, param10 * 4.187 / 1000, 1000000000);
                double MtBenz = calcDyOxyPhbGxbMt(0.0006, param5, param10 * 4.187 / 1000, 1000000000);
                double MtPiren = calcDyOxyPhbGxbMt(0.0008, param5, param10 * 4.187 / 1000, 1000000000);


                double[] valueList = { mNO2, mNO, mCO, mSO2, mC,mMZ, mBenzP,
                    dyOxy, MtB, MtK, MtBenz, MtPiren};
                ...
                double[] resultValueList = { mNO2, mNO, mCO, mSO2, mC, mMZ, mBenzP,
                    dyOxy, MtB, MtK, MtBenz, MtPiren, sum };
