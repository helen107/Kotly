...
namespace KyrsApp
{
    public partial class BKZ5039gas : Form
    {
        public BKZ5039gas()
        {
            InitializeComponent();
        ...
        private void addToDb_Click(object sender, EventArgs e)
        {
            ...
            addToDb.BackColor = Color.DarkGray;
            calc.BackColor = Color.RosyBrown;
        }
        ...
        private void calc_Click(object sender, EventArgs e)
        {
                ...
                valueItem5.Text != "" && valueItem6.Text != "")
            {
                ...
                double mSO2 = calcMSO2(param1);
                double mC = calcMC(param1, param2);
                double mMZ = calcMZ(param1);
                double mBenzP = calcBenzP(param1);

                double mRtut = calcHardMetal(param1, 0.05, 0, 0.05);

                double dyOxy = calcDyOxyPhbGxbMt(param1, param2 * 4.187 / 1000, 0.001, 100000);

                double MtB = calcDyOxyPhbGxbMt(param1, param2 * 4.187 / 1000, 0.0008, 1000000000) * 0.2;
                double MtK = calcDyOxyPhbGxbMt(param1, param2 * 4.187 / 1000, 0.0008, 1000000000) * 0.1;
                double MtBenz = calcDyOxyPhbGxbMt(param1, param2 * 4.187 / 1000, 0.0008, 1000000000) * 0.1;
                double MtPiren = calcDyOxyPhbGxbMt(param1, param2 * 4.187 / 1000, 0.0008, 1000000000) * 0.2;
